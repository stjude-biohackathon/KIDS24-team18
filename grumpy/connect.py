...
def grumpyConnect(keyFile, apiType, gptModel, grumpyRole, query, outfileName, max_tokens=128000,
                  top_p=0.95, frequency_penalty=0, presence_penalty=1, temperature=0.1, hidden=True, saveResponse=True):
